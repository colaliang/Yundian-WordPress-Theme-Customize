            ...
            <?php if ($news->have_posts()) : while ($news->have_posts()) : $news->the_post(); ?>
                <article class="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="h-48 overflow-hidden">
                        ...
                        <?php else : ?>
                            <div class="w-full h-full flex items-center justify-center" style="background-color: #FFF5ED;">
                    ...
                    <div class="p-5">
                        ...
                        <h3 class="font-semibold text-lg mb-2" style="color: #333;">
                        ...
                        <a href="<?php the_permalink(); ?>" class="text-sm font-medium inline-flex items-center gap-1" style="color: #F37021;">
