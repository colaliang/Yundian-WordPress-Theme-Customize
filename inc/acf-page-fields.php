...
function erdu_register_page_field_groups()
{
    ...
    acf_add_local_field_group(array(
        ...
        'fields'   => array(
            ...
            array('key' => 'field_home_hero_height', 'label' => __('Hero Min Height', 'erdu-wp'), 'name' => 'home_hero_height', 'type' => 'select',
                'choices' => array(
                    'auto'    => __('Auto (fit content)', 'erdu-wp'),
                    '60vh'    => __('Small (60vh)', 'erdu-wp'),
                    '70vh'    => __('Medium (70vh)', 'erdu-wp'),
                    '80vh'    => __('Large (80vh)', 'erdu-wp'),
                    '100vh'   => __('Full Screen (100vh)', 'erdu-wp'),
                ),
                'default_value' => '80vh',
                'instructions' => __('Hero section minimum height. Content will expand if taller.', 'erdu-wp')),
    ...
    acf_add_local_field_group(array(
        ...
        'fields'   => array(
            ...
            array('key' => 'field_hd_show_search', 'label' => __('Show Search', 'erdu-wp'), 'name' => 'hd_show_search', 'type' => 'true_false',
                'ui' => 1, 'default_value' => 1),
            array('key' => 'field_hd_search_style', 'label' => __('Search Style', 'erdu-wp'), 'name' => 'hd_search_style', 'type' => 'select',
                'choices' => array(
                    'fullscreen' => __('Fullscreen Overlay', 'erdu-wp'),
                    'dropdown'   => __('Dropdown Box', 'erdu-wp'),
                    'inline'     => __('Inline Input', 'erdu-wp'),
                ),
                'default_value' => 'fullscreen', 'conditional_logic' => array(array(array('field' => 'field_hd_show_search', 'operator' => '==', 'value' => '1')))),
            array('key' => 'field_hd_search_size', 'label' => __('Search Icon Size', 'erdu-wp'), 'name' => 'hd_search_size', 'type' => 'select',
                'choices' => array('sm' => __('Small', 'erdu-wp'), 'md' => __('Medium', 'erdu-wp'), 'lg' => __('Large', 'erdu-wp')),
                'default_value' => 'sm', 'conditional_logic' => array(array(array('field' => 'field_hd_show_search', 'operator' => '==', 'value' => '1')))),
            array('key' => 'field_hd_search_width', 'label' => __('Search Input Width (Inline)', 'erdu-wp'), 'name' => 'hd_search_width', 'type' => 'select',
                'choices' => array('w-48' => __('Small', 'erdu-wp'), 'w-64' => __('Medium', 'erdu-wp'), 'w-80' => __('Large', 'erdu-wp')),
                'default_value' => 'w-64', 'conditional_logic' => array(array(array('field' => 'field_hd_search_style', 'operator' => '==', 'value' => 'inline')))),
            array('key' => 'field_hd_search_history', 'label' => __('Enable Search History', 'erdu-wp'), 'name' => 'hd_search_history', 'type' => 'true_false',
                'ui' => 1, 'default_value' => 1, 'conditional_logic' => array(array(array('field' => 'field_hd_show_search', 'operator' => '==', 'value' => '1')))),
            array('key' => 'field_hd_search_promoted', 'label' => __('Promoted Search Keywords', 'erdu-wp'), 'name' => 'hd_search_promoted', 'type' => 'text',
                'instructions' => __('Enter keywords separated by comma (e.g. Track Light, Spotlight, Downlight)', 'erdu-wp'),
                'conditional_logic' => array(array(array('field' => 'field_hd_show_search', 'operator' => '==', 'value' => '1')))),
            ...
            array(
                'key'          => 'field_hd_element_popups',
                'label'        => __('Element Popups', 'erdu-wp'),
                'name'         => 'hd_element_popups',
                'type'         => 'repeater',
                'button_label' => __('Add Element Popup', 'erdu-wp'),
                'instructions' => __('Configure icon-triggered popup elements in the header. Similar to Mega Menu blocks but for individual icons.', 'erdu-wp'),
                'sub_fields'   => array(
                    array('key' => 'field_hd_ep_key', 'label' => __('Element Key', 'erdu-wp'), 'name' => 'key', 'type' => 'select', 'required' => 1,
                        'choices' => array(
                            'search'  => __('Search', 'erdu-wp'),
                            'lang'    => __('Language Switcher', 'erdu-wp'),
                            'contact' => __('Contact Info', 'erdu-wp'),
                            'social'  => __('Social Icons', 'erdu-wp'),
                            'custom'  => __('Custom Icon', 'erdu-wp'),
                        ),
                        'default_value' => 'custom'),
                    array('key' => 'field_hd_ep_icon', 'label' => __('Icon SVG Path (d attribute)', 'erdu-wp'), 'name' => 'icon', 'type' => 'textarea', 'rows' => 2,
                        'instructions' => __('Enter SVG path "d" attribute. Leave empty to use default icon.', 'erdu-wp')),
                    array('key' => 'field_hd_ep_icon_image', 'label' => __('Icon Image (optional)', 'erdu-wp'), 'name' => 'icon_image', 'type' => 'image',
                        'return_format' => 'url', 'preview_size' => 'thumbnail',
                        'instructions' => __('Upload a custom icon image instead of SVG.', 'erdu-wp')),
                    array('key' => 'field_hd_ep_label', 'label' => __('Label Text', 'erdu-wp'), 'name' => 'label', 'type' => 'text',
                        'instructions' => __('Optional label shown next to the icon.', 'erdu-wp')),
                    array('key' => 'field_hd_ep_popup_type', 'label' => __('Popup Type', 'erdu-wp'), 'name' => 'popup_type', 'type' => 'select', 'required' => 1,
                        'choices' => array(
                            'none'    => __('No Popup (Icon Only)', 'erdu-wp'),
                            'dropdown'=> __('Dropdown Panel', 'erdu-wp'),
                            'modal'   => __('Modal / Overlay', 'erdu-wp'),
                            'mega'    => __('Mega Menu Style', 'erdu-wp'),
                        ),
                        'default_value' => 'dropdown'),
                    array('key' => 'field_hd_ep_popup_width', 'label' => __('Popup Width', 'erdu-wp'), 'name' => 'popup_width', 'type' => 'select',
                        'choices' => array(
                            'auto'    => __('Auto', 'erdu-wp'),
                            'sm'      => __('Small (280px)', 'erdu-wp'),
                            'md'      => __('Medium (400px)', 'erdu-wp'),
                            'lg'      => __('Large (600px)', 'erdu-wp'),
                            'full'    => __('Full Width', 'erdu-wp'),
                        ),
                        'default_value' => 'auto',
                        'conditional_logic' => array(array(array('field' => 'field_hd_ep_popup_type', 'operator' => '!=', 'value' => 'none'))),
                    array(
                        'key'          => 'field_hd_ep_blocks',
                        'label'        => __('Popup Content Blocks', 'erdu-wp'),
                        'name'         => 'blocks',
                        'type'         => 'repeater',
                        'button_label' => __('Add Block', 'erdu-wp'),
                        'conditional_logic' => array(array(array('field' => 'field_hd_ep_popup_type', 'operator' => '!=', 'value' => 'none'))),
                        'sub_fields'   => array(
                            array('key' => 'field_hd_epb_type', 'label' => __('Block Type', 'erdu-wp'), 'name' => 'type', 'type' => 'select',
                                'choices' => array(
                                    ...
                                    'contact'    => __('Contact Info', 'erdu-wp'),
                                    'social'     => __('Social Links', 'erdu-wp'),
                                ),
                                'default_value' => 'links'),
                            array('key' => 'field_hd_epb_title', 'label' => __('Block Title', 'erdu-wp'), 'name' => 'title', 'type' => 'text'),
                            array('key' => 'field_hd_epb_links', 'label' => __('Links', 'erdu-wp'), 'name' => 'links', 'type' => 'repeater',
                                'button_label' => __('Add Link', 'erdu-wp'),
                                'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'links'))),
                                'sub_fields' => array(
                                    array('key' => 'field_hd_epbl_label', 'label' => __('Label', 'erdu-wp'), 'name' => 'label', 'type' => 'text', 'required' => 1),
                                    array('key' => 'field_hd_epbl_url', 'label' => __('URL', 'erdu-wp'), 'name' => 'url', 'type' => 'url', 'required' => 1),
                                    array('key' => 'field_hd_epbl_desc', 'label' => __('Description', 'erdu-wp'), 'name' => 'desc', 'type' => 'textarea', 'rows' => 2),
                                )),
                            array('key' => 'field_hd_epb_image', 'label' => __('Image', 'erdu-wp'), 'name' => 'image', 'type' => 'image',
                                'return_format' => 'url', 'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'image')))),
                            array('key' => 'field_hd_epb_image_link', 'label' => __('Image Link', 'erdu-wp'), 'name' => 'image_link', 'type' => 'url',
                                'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'image')))),
                            array('key' => 'field_hd_epb_html', 'label' => __('Custom HTML', 'erdu-wp'), 'name' => 'html', 'type' => 'textarea', 'rows' => 6,
                                'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'html')))),
                            array('key' => 'field_hd_epb_contact_phone', 'label' => __('Phone', 'erdu-wp'), 'name' => 'contact_phone', 'type' => 'text',
                                'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'contact')))),
                            array('key' => 'field_hd_epb_contact_email', 'label' => __('Email', 'erdu-wp'), 'name' => 'contact_email', 'type' => 'email',
                                'conditional_logic' => array(array(array('field' => 'field_hd_epb_type', 'operator' => '==', 'value' => 'contact')))),
            ...
            // ===== Language Tab =====
            array('key' => 'field_hd_tab_lang', 'label' => __('Language', 'erdu-wp'), 'name' => '', 'type' => 'tab'),
            array('key' => 'field_hd_lang_style', 'label' => __('Display Style', 'erdu-wp'), 'name' => 'hd_lang_style', 'type' => 'radio',
                'choices' => array(
                    'text'     => __('Text Toggle (EN / CN)', 'erdu-wp'),
                    'dropdown' => __('Dropdown Menu', 'erdu-wp'),
                ),
                'default_value' => 'text', 'layout' => 'horizontal'),
            array('key' => 'field_hd_lang_show_flags', 'label' => __('Show Flags', 'erdu-wp'), 'name' => 'hd_lang_show_flags', 'type' => 'true_false',
                'ui' => 1, 'default_value' => 0,
                'instructions' => __('Display country flag icons next to language labels.', 'erdu-wp')),
            array(
                'key'          => 'field_hd_lang_list',
                'label'        => __('Languages', 'erdu-wp'),
                'name'         => 'hd_lang_list',
                'type'         => 'repeater',
                'button_label' => __('Add Language', 'erdu-wp'),
                'instructions' => __('Configure available languages. Mark one as active (current).', 'erdu-wp'),
                'sub_fields'   => array(
                    array('key' => 'field_hd_ll_code', 'label' => __('Language Code', 'erdu-wp'), 'name' => 'code', 'type' => 'text', 'required' => 1,
                        'instructions' => __('e.g. en, zh, es, fr', 'erdu-wp')),
                    array('key' => 'field_hd_ll_label', 'label' => __('Display Label', 'erdu-wp'), 'name' => 'label', 'type' => 'text', 'required' => 1,
                        'instructions' => __('e.g. EN, 中文, ES', 'erdu-wp')),
                    array('key' => 'field_hd_ll_url', 'label' => __('URL', 'erdu-wp'), 'name' => 'url', 'type' => 'url', 'required' => 1,
                        'instructions' => __('Link to the language version of the site.', 'erdu-wp')),
                    array('key' => 'field_hd_ll_flag', 'label' => __('Flag Icon', 'erdu-wp'), 'name' => 'flag', 'type' => 'image',
                        'return_format' => 'url', 'preview_size' => 'thumbnail',
                        'instructions' => __('Optional: Upload a flag image (e.g. 32x32px).', 'erdu-wp')),
                    array('key' => 'field_hd_ll_active', 'label' => __('Current Active', 'erdu-wp'), 'name' => 'active', 'type' => 'true_false',
                        'ui' => 1, 'default_value' => 0,
                        'instructions' => __('Mark this as the currently active language.', 'erdu-wp')),
                ),
            ),
