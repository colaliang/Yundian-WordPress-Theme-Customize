...
class Erdu_Header_Search {
    public static function render() {
        ...
        $size     = erdu_header_field('hd_search_size', 'md'); // sm, md, lg
        ...
        if ($style === 'inline') {
            ...
            <div class="flex items-center group relative erdu-search-inline">
                <form action="<?php echo esc_url(home_url('/')); ?>" method="get" class="flex items-center bg-gray-50 rounded-full px-4 py-2 w-48 md:w-64 focus-within:w-72 focus-within:bg-white focus-within:ring-2 focus-within:ring-orange-500 transition-all duration-300">
        ...
        <div class="flex items-center relative erdu-search-trigger-container">
            ...
            <?php if ($style === 'dropdown') : ?>
                <!-- Dropdown Search -->
                <div class="absolute right-0 top-full mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-100 opacity-0 invisible transition-all z-[60] erdu-search-dropdown-panel">
                    <div class="p-4 border-b border-gray-100">
                        <form action="<?php echo esc_url(home_url('/')); ?>" method="get" class="flex items-center gap-2">
                            ...
                            <button type="submit" class="p-2 text-white rounded erdu-bg-primary hover:opacity-90">
