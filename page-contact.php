                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5"><?php _e('Tel', 'erdu-wp'); ?></p>
                                    <p class="text-sm text-gray-700 font-medium"><?php echo esc_html($phone); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5"><?php _e('Mobile', 'erdu-wp'); ?></p>
                                    <p class="text-sm text-gray-700 font-medium"><?php echo esc_html($mobile); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5"><?php _e('Email', 'erdu-wp'); ?></p>
                                    <p class="text-sm text-gray-700 font-medium"><?php echo esc_html($email_addr); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5"><?php _e('Address', 'erdu-wp'); ?></p>
                                    <p class="text-sm text-gray-700 font-medium" style="line-height: 1.6;"><?php echo nl2br(esc_html($address)); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <p class="text-xs text-gray-400 mb-0.5"><?php _e('Working Hours', 'erdu-wp'); ?></p>
                                    <p class="text-sm text-gray-700 font-medium"><?php echo esc_html($hours); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <div class="grid md:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <select name="contact_product" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors text-sm bg-white">
                                            ...
                                            <option value="ut">UT Series - Track Light</option>
                                            <option value="gs">GS Series - Grille Spot</option>
                                            <option value="dt">DT Series - Down Light</option>
                                            <option value="lt">LT Series - Linear Light</option>
                                            <option value="track">Magnetic Track Rail</option>
                                            <option value="other">Other / Custom</option>
                                        </select>
                                    </div>
                                </div>

                                <!-- Row 4: Estimated Quantity -->
                                <div>
