    ...
    <div class="flex flex-col lg:flex-row gap-12 xl:gap-16 mb-16 erdu-product-columns">
        ...
        <div class="w-full xl:w-1/2 self-start xl:sticky xl:top-24">
            ...
            <div class="flex flex-row items-center gap-4 mb-8">
                ...
                ?>
                <a href="<?php echo esc_url($url); ?>" style="width: 128px; height: 48px;" class="inline-flex items-center justify-center erdu-bg-primary text-white font-medium rounded transition-colors text-sm shadow-sm erdu-hover-primary">
                ...
                ?>
                <a href="<?php echo esc_url($wa_url); ?>" target="_blank" style="width: 128px; height: 48px; background-color: #25D366;" class="inline-flex items-center justify-center text-white font-medium rounded transition-colors text-sm shadow-sm" onmouseover="this.style.backgroundColor='#128C7E'" onmouseout="this.style.backgroundColor='#25D366'">
