...
<div id="section-faq" class="erdu-content-block scroll-mt-32">
    <h2 class="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-100"><?php esc_html_e('FAQ', 'erdu-wp'); ?></h2>
    <div class="space-y-4">
        ...
        <div class="erdu-faq-item border border-gray-200 rounded-lg overflow-hidden">
            <button type="button" class="erdu-faq-question w-full flex items-center justify-between px-6 py-4 text-left bg-white hover:bg-gray-50 transition-colors">
                <span class="text-base font-bold text-gray-900 pr-4"><?php echo esc_html($question); ?></span>
            ...
            <div class="erdu-faq-answer hidden px-6 pb-4 text-gray-600 text-base leading-relaxed">
