    ...
    <div class="space-y-5">
        ...
        <div class="erdu-faq-item border border-gray-200 rounded-lg overflow-hidden">
            <button type="button" class="erdu-faq-question w-full flex items-center justify-between px-6 py-4 text-left bg-white hover:bg-gray-50 transition-colors">
                ...
                <svg class="erdu-faq-icon w-5 h-5 text-gray-500 flex-shrink-0 transition-transform duration-300 <?php echo $is_first ? 'rotate-180' : ''; ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </button>
            <div class="erdu-faq-answer px-6 pb-5 text-gray-600 text-base leading-relaxed <?php echo $is_first ? '' : 'hidden'; ?>">
