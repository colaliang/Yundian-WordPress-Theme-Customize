...
<div id="section-downloads" class="erdu-content-block scroll-mt-32">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        ?>
            <a href="<?php echo esc_url($file); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-between text-base font-medium text-orange-600 hover:text-orange-800 transition-all bg-orange-50 hover:bg-orange-100 border border-orange-100 px-6 py-4 rounded-xl shadow-sm hover:shadow-md">
